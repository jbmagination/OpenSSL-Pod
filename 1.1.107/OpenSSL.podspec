Pod::Spec.new do |s|
  ...
  s.source          = { :http => "https://www.openssl.org/source/openssl-1.1.1g.tar.gz", :sha1 => "b58d5d0e9cea20e571d903aafa853e2ccd914138"}
  ...
  s.prepare_command = <<-CMD
	...
	curl https://www.openssl.org/source/openssl-1.1.1g.tar.gz --output "${CURRENTPATH}/file.tgz"
